...
let isUpdatingVehicle = ref(false);
...
<template>
  <div class="max-w-sm mx-auto">
    ...
    <h1 class="font-bold text-2xl mb-4">Actualizar el vehículo:</h1>
    ...
    <div class="mb-5">
      ...
      <input v-model="props.matricula" type="text" id="matricula" :disabled=true
             class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
             placeholder="1111AAA">
    </div>
    <div class="mb-5">
      <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre</label>
      <input v-model="vehicle.nombre" type="text" id="nombre"
             class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
             placeholder="Mi vehiculo" required>
    </div>
    <div class="mb-5">
      <label for="tipo_motor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tipo de motor</label>
      <select v-model="vehicle.tipoMotor" id="tipo_motor"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <div class="mb-5">
      ...
      <input v-model="vehicle.consumo100Km" type="number" id="consumo"
             class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div>
      <button type="submit" :disabled="isUpdatingVehicle"
        ...
        <svg v-if="isUpdatingVehicle" aria-hidden="true" role="status"
        ...
        <span v-if="isUpdatingVehicle">Actualizando...</span>
