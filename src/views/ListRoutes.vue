        ...
        <div
            ...
            <div class="flow-root">
                <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                    <li v-for="route in listOfRoutes" class="py-3 sm:py-4">
                        <div class="flex items-center">
                            ...
                            <div class="flex-1 min-w-0 ms-4">
                              ...
                              <p class="text-sm text-gray-500 truncate dark:text-gray-400">
                                {{ `Distancia: ${route['distance'].toFixed()} km` }}
                              </p>
                            </div>
                            <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                <button type="button" v-if="!route['isFav']"
                                        @click="markAsFavourite(route['name'])" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                                ...
                                <button type="button" v-if="route['isFav']"
                                        @click="unmarkAsFavourite(route['name'])" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
            ...
            <div class="flex justify-center">
                <button type="button"
                        @click="router.push({path: '/registerRoute'})"
...
function generateListOfRoutes() {
  listOfRoutes.value = Object.values(userManager.getListOfRoutes()).map(obj => obj);
  listOfRoutes.value.sort((a: Route, b: Route) => {
...
async function markAsFavourite(name: string) {
  await userManager.markRouteAsFavourite(name);
  generateListOfRoutes()
}
